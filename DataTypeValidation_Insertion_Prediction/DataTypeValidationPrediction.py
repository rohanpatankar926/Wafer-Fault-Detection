...
class dBOperation:
    ...
    def dataBaseConnection(self,DatabaseName):
        ...
        try:
            ...
            file = open("Prediction_Logs/DataBaseConnectionLog.log", 'a+')
    ...
    def createTableDb(self,DatabaseName,column_names):
        ...
        try:
            ...
            file = open("Prediction_Logs/DbTableCreateLog.log", 'a+')
    ...
    def insertIntoTableGoodData(self,Database):
        ...
        log_file = open("Prediction_Logs/DbInsertLog.log", 'a+')
    ...
    def selectingDatafromtableintocsv(self,Database):
        ...
        log_file = open("Prediction_Logs/ExportToCsv.log", 'a+')
        try:
            conn = self.dataBaseConnection(Database)
